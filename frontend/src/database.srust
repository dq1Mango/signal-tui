...
// pub use lib::OnNewIdentity;
// pub use lib::SqliteStore;
// pub use lib::SqliteStoreError;
...
pub struct SqliteStore {
  pub db: SqlitePool,
  pub trust_new_identities: OnNewIdentity,
}
...
impl SqliteStore {
  ...
  pub(crate) async fn save_message(
    ...
    clone: presage::libsignal_service::prelude::Content,
  ) -> _ {
    todo!()
  }
}
